...
# use hardware rate limiting instead of software (only supported by 10GBe controllers such as X540)
USE_RATE_TYPE="sw"  #hw poison
# maximum number of cores used by each benchmark
USE_MAX_CORES=3 #TODO implement option in scripts
...
TEST_LATENCY_RT=1000   		# <throughput rate>
